...
class assignment3{
    ...
    void readfiles(){
    try {
        Scanner s1=new Scanner(new FileReader("Assignment3.java/menu.csv"));
        Scanner s2=new Scanner(new FileReader("Assignment3.java/output.csv"));
        String s;
        while(s1.hasNext()){
            s=s1.nextLine();
            String[] str=s.split(",");
    ...
    void disply(ArrayList<ArrayList<String>>a1){
        int n=a1.size();
        for(int i=0;i<n;i++){
    ...
    void cancelbill(){
        ...
        if(n>t){
            ...
            try {
                FileWriter objq=new FileWriter("Assignment3.java/output.csv",false);
                for(int i=0;i<(a2.size());i++){
                    ArrayList<String>str1=a2.get(i);
                    String str11=String.join(",",str1);
                    str11+="\n";
                    FileWriter objq1=new FileWriter("Assignment3.java/output.csv",true);
                    objq1.write(str11);
                    objq1.close();
                }
                    objq.close();
    ...
    void order(){
        ...
        if(ch=='y'){
            ...
            if(ch1=='y'){
                ...
                a+=s+"Approved";
                try {
                    File newn=new File("Assignment3.java/output.csv");
